...
#define bathroom  (objs + 45)
#define wallBathroom  (objs + 46)
#define intobathroom   (objs + 47)
#define exitBathroom (objs + 48)
#define living_room  (objs + 49)
#define intoLiving_room   (objs + 50)
#define exitLiving_room (objs + 51)
#define storage_room  (objs + 52)
#define wallStorage_room  (objs + 53)
#define intoStorage_room   (objs + 54)
#define exitStorage_room (objs + 55)
#define bedroom  (objs + 56)
#define wallBedroom  (objs + 57)
#define intoBedroom   (objs + 58)
#define exitBedroom (objs + 59)
#define garage  (objs + 60)
